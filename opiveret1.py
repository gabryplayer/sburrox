...
""")
        ...
        cmd = os.system("clear")
        print("""
Hi, my name is Parzival.
I worked as a freelance translator and proofreader for 2 years, mostly for fun. I'm a native Italian speaker🇮🇹 and professionally fluent in English🇬🇧, i know a bit of Spanish🇪🇸 and French🇫🇷 and I'm learning Esperanto.
Aside from my interest in languages, i'm an IT Specialist/Junior Developer and, my services, includes Website development and design (even on WordPress if needed) Crypto Development and deployment🪙, Cloud solutions development and security (on AWS)☁️ but mostly IT Security consultations and analysis👨‍💻 
Right now I'm TRYING to learn ML, AIs and Neural Networks in Python🧠
""")
        quit()
    elif var == 00:
        exit()
...
-----------------------------------------------------------------------------------------
The process of cracking a password could take hours and even days to complete. Bruteforcing speed depends on the 
 size of your wordlistfile, so be patient.
""")
        print("\nEnter your choise here : ?")
        set = str(input(""))
        if set == "1":
